...
export const FlavorPicker = memo(function FlavorPicker({
  isOpen,
  onClose,
  flavors,
  selectedFlavor,
    ...
    >
      <div className="p-6 border-b border-base-300">
        ...
        <p className="text-sm text-base-content/60 mt-1">
          Selectionnez la taille de votre instance
        </p>
      </div>
          ...
          {availableFlavors.map((flavor) => {
            ...
            return (
              <button
                ...
                className={`
                  flex items-center justify-between p-4 border-2 transition-all text-left cursor-pointer
                  ${
                    isSelected
