...
import { formatPrice, formatMonthlyPrice } from '@/lib/costCalculator'
  ...
  return (
    <div className="space-y-6 animate-cost-fade-in">
      ...
      {cost.runtimesDetail.length > 0 && (
        <div className="space-y-4 animate-cost-slide-up" style={{ animationDelay: '0.1s' }}>
      ...
      {cost.addonsDetail.length > 0 && (
        <div className="space-y-4 animate-cost-slide-up" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center gap-2">
