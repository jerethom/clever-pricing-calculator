...
export const RuntimeCardScaling = memo(function RuntimeCardScaling({
	...
	const handleAddProfile = useCallback(() => {
		...
		const lastFlavor =
			availableFlavors[availableFlavors.length - 1]?.name ??
...
function ProfileCard({
	...
	return (
		<div className="flex items-center justify-between p-3 border border-base-300 bg-base-100 hover:border-primary/30 transition-colors w-full">
			<button
				type="button"
