...
import { hexToRgba, LOAD_LEVEL_OPACITIES, PROFILE_COLORS } from "@/constants";
import { toast } from "@/store/toastStore";
import type { DayOfWeek, LoadLevel, WeeklySchedule } from "@/types";
import {
...
const CompactPresetButton = memo(function CompactPresetButton({
	...
	const [hoveredSchedule, setHoveredSchedule] = useState<WeeklySchedule | null>(
		null,
	);
