...
export const Icons = {
  ...
  Server: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Puzzle: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Warning: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Info: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Folder: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Menu: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  CalendarYear: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  TrendingUp: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Building: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Move: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  MoreHorizontal: ({ className = "w-4 h-4" }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Logo: ({ className = "w-6 h-6" }: IconProps) => (
    ...
    >
      {/* Face gauche du cube */}
      <path d="M2 8l10 6v10L2 18V8z" fill="url(#logo-gradient-left)" />
      {/* Face droite du cube */}
      <path d="M22 8L12 14v10l10-6V8z" fill="url(#logo-gradient-right)" />
      {/* Face superieure du cube */}
      <path d="M12 0L2 6l10 6 10-6L12 0z" fill="url(#logo-gradient-top)" />
      <defs>
        <linearGradient
          id="logo-gradient-left"
          x1="0%"
          y1="0%"
          x2="100%"
          y2="100%"
